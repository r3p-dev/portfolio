export const en = {
  ...
  guestbook_error_message_long: 'Please keep your message under {max} characters.',
  guestbook_error_duplicate: 'That message was just signed. Try something different.',
  ...
  home_experiences_lead: 'A timeline of my professional journey in software development.',
