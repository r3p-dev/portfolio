...
export const id: Messages = {
  ...
  guestbook_error_duplicate: 'Pesan itu baru saja dikirim. Coba tulis yang lain.',
  ...
  home_experiences_lead: 'Perjalanan profesional saya di pengembangan perangkat lunak.',
